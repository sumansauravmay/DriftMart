          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://react.dev/" nonce="hover:underline">React</a>
                      </li>
                      <li>
              ...
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://github.com/sumansauravmay" className="hover:underline ">Github</a>
                      </li>
                      <li>
                          <a href="https://www.linkedin.com/in/suman-saurav-06896b231/" className="hover:underline">LinkedIn</a>
                      </li>
                  </ul>
              </div>
              <div>
